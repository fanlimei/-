...
public class Sendmail {
    ...
    public static String myEmailAccount = "pycharm_mail@126.com";
    public static String myEmailPassword = "123456aaa";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "907385640@qq.com";
...
//        DataHandler dh = new DataHandler(new FileDataSource("F:\\Three\\800.jpg")); // 读取本地文件
//     
...
//        text.setContent("<img src='cid:image_fairy_tail'/>", "text/html;charset=UTF-8");
        text.setContent("这是测试报告", "text/html;charset=UTF-8");
...
//        text_image.setContent(mm_text_image);
        ...
        DataHandler dh2 = new DataHandler(new FileDataSource("F:\\Three\\lhzgithub\\auto2018\\test-output\\html.zip"));  // 读取本地文件
